# REST-assured [![Build Status](https://travis-ci.org/jayway/rest-assured.svg?branch=test-travis)](https://travis-ci.org/jayway/rest-assured)![tag](http://img.shields.io/github/tag/rest-assured/releases.svg)
